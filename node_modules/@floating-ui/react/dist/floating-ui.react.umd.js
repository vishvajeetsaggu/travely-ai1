      ...
      return function onMouseMove(event) {
        ...
        if (tree) {
          ...
          const isOverOpenChild = openChildren.some(child => {
            var _child$context;
            const childFloating = (_child$context = child.context) == null ? void 0 : _child$context.elements.floating;
            return childFloating && isInside(clientPoint, childFloating.getBoundingClientRect());
          });
          if (isOverOpenChild || openChildren.length && isInside(clientPoint, rect)) {
            return;
          }
        }
